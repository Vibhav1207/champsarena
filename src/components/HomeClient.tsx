      ...
      <main className="pt-0 text-primary">
        ...
        <section className="max-w-container-max mx-auto px-md py-lg md:py-xl grid grid-cols-1 lg:grid-cols-12 gap-md lg:gap-xl">
          ...
          <div className="lg:col-span-5 flex flex-col">
            ...
            {announcement ? (
              <div className="bg-white border-4 border-primary neo-brutalist-shadow overflow-hidden group flex-grow flex flex-col">
                <div className="h-64 overflow-hidden border-b-4 border-primary grayscale group-hover:grayscale-0 transition-all duration-500 relative select-none">
                  <Image
          ...
          <div className="lg:col-span-7 flex flex-col">
            ...
            {upcomingEvents.length > 0 ? (
              <div className="flex flex-wrap md:flex-nowrap gap-md items-stretch">
                {upcomingEvents.map((event) => {
                  ...
                  return (
                    <div key={event.id} className={`flex-grow w-full md:w-80 bg-white border-4 ${isGoldBorder ? "border-accent-yellow" : "border-primary"} p-md neo-brutalist-shadow-hover transition-all flex flex-col justify-between text-left`}>
                      <div>
        ...
        <section className="bg-white py-xl border-y-4 border-primary relative overflow-hidden">
          ...
          <div className="max-w-container-max mx-auto px-md relative z-10">
            ...
            {topPlayers.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-md md:gap-xl items-end max-w-[896px] mx-auto pt-sm text-left">
                {/* Champion 2 (Left) */}
              ...
              <div className="text-center py-16">
                ...
                <p className="text-primary/60 font-black uppercase text-sm font-bold">No trainers registered yet.</p>
              </div>
            )}
          </div>
        </section>
